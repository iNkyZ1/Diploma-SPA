...
import { registerThunk, selectAuth } from '../../features/auth/model/authSlice';
...
function getServerErrorMessage(err) {
	...
	if (err.status === 409) return 'Такой логин уже занят';
...
export function AuthRegisterPage() {
	...
	const onSubmit = async (e) => {
		...
		const res = await dispatch(registerThunk({ login: login.trim(), password }));
